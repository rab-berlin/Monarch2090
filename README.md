...
Gut, du solltest aber wenigstens die Abschnitte [Walzensymbole](#walzensymbole) und [Spielablauf und Display](#spielablauf-und-display) lesen, sonst ist das Ganze für dich nur ein viel zu kleines Display mit willkürlich erscheinenden Zahlen... Beachte auch, dass du ein bisschen Peripherie aufbauen musst (z.B. Piezo und Taster anschließen). 
